   ...
   .imagens{
       object-fit: cover;
            ...
            <?php foreach ($listaProduto as $linhaProduto){ ?>
                <div class="espaco">
                <div class="card" style="width: 18rem;" id="espaco">
                    <center><img class="imagens" width="150px" height="150px" src=" <?php echo 'restrito/'.$linhaProduto['fotoproduto'] ?> "></center>
                        <div class="card-body">
                            <h5 class="card-title"><?php echo $linhaProduto['textoproduto'] ?></h5>
...
<!--
     <table class="table">
                    ...
                    <tbody id='resultado'>
                    <?// foreach ($listaProduto as $linhaProduto){ ?>
                            <tr>
                                <td><?// echo $linhaProduto['descproduto'] ?></td>
                                <td><?// echo $linhaProduto['textoproduto'] ?></td>
                                <td><img width="50px" src=" <?// echo 'restrito/'.$linhaProduto['fotoproduto'] ?> "></td>
                            </tr>
                        <?// } ?>
                    </tbody>
                </table>
